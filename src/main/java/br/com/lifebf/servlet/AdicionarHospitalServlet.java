...
public class AdicionarHospitalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int idPlano = Integer.parseInt(req.getParameter("id_plano"));
        ...
        boolean validarQuantidadeHospitais = planoDao.validarQuantidadeHospitais(idPlano, idMembro);
        if (!validarQuantidadeHospitais) {
            resp.sendError(HttpServletResponse.SC_FORBIDDEN, "Limite de hospitais atingido.");
            return;
        }
