...
public class ClienteDao {
    ...
    public void createCliente(Cliente cliente) {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/lifebf?user=root&password=Admin@local");
    ...
    public boolean loginCliente(Cliente cliente) {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/lifebf?user=root&password=Admin@local");
             PreparedStatement preparedStatement = conn.prepareStatement(sql)) {
